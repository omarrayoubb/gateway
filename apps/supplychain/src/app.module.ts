  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        password: configService.get('SUPPLYCHAIN_DB_PASSWORD') || configService.get('DB_PASSWORD') || 'postgres',
        database: configService.get('SUPPLYCHAIN_DB_DATABASE') || configService.get('DB_DATABASE') || 'supplychain-backend',
